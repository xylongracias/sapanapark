...
<?php echo $this->Form->create('ExpenseBill'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Expense Bill'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ExpenseBill.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ExpenseBill.id'))); ?></li>
