<div class="flats index">
	...
	<tr>
		<td><?php echo h($flat['Flat']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($flat['Building']['name'], array('controller' => 'buildings', 'action' => 'view', $flat['Building']['id'])); ?>
		</td>
		<td><?php echo h($flat['Flat']['name']); ?>&nbsp;</td>
		<td><?php echo h($flat['Flat']['floor']); ?>&nbsp;</td>
		<td><?php echo h($flat['Flat']['date_created']); ?>&nbsp;</td>
		<td><?php echo h($flat['Flat']['date_modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $flat['Flat']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $flat['Flat']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $flat['Flat']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $flat['Flat']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
