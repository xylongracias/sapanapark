<div class="buildings index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('no_of_flats'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($building['Building']['name']); ?>&nbsp;</td>
		<td><?php echo h($building['Building']['no_of_flats']); ?>&nbsp;</td>
		<td><?php echo h($building['Building']['date_created']); ?>&nbsp;</td>
		<td><?php echo h($building['Building']['date_modified']); ?>&nbsp;</td>
		<td class="actions">
