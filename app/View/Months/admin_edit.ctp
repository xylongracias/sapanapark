...
<?php echo $this->Form->create('Month'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Month'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Month.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Month.id'))); ?></li>
